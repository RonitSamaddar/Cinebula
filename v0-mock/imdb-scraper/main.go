...
func fetchIMDBPage(imdbID string) (string, error) {
	...
	cmd := exec.Command("curl",
		...
		"-b", "session-id=130-3844437-4031345; session-id-time=2082787201l; ubid-main=133-4880155-8879254; ci=eyJhZ2VTaWduYWwiOiJBRFVMVCIsImlzR2RwciI6ZmFsc2V9; ad-oo=0; session-token=RHta43u72G/TEj3O0HKuVyx2pUDEoi0FCw5z4jRSWKsvy/adVIp/jFe0SCx6RDF6w1ZZeDtCKW+AoSMYYLvJGziDbQQ1KNmVTZhWash0f8pyzqyoJIzkKryjQOZ+HqsaBrgHNCENpHYXVH+dbLgXZz/yCk/suKINowNks9xCQdBqIrHFH9ObsrMN1Z/0Bpl/FJG710XYTggoqFz/lG/KCORd9TCMBiKP; csm-hit=tb:E2686FZ2JGHT37RM6TK5+s-GPGFBEFWHDASMW0TW46P|1780570474398&t:1780570474398&adb:adblk_no; aws-waf-token=3e012f03-fb89-43a7-b43c-79ed67fb5462:EQoAdQ5K+98KAAAA:ucxMi+4gcZDCKEj2R0Br21Sva81yWtNzChS1mIHmeQ1GO17PquCkMhwFgz+bJh9Mo0DB8dXvvX67AIFqPFT4O0ANl5GsMgnHoNHms4R+tvNIfn+yX0eZDnMoBMl2vZg0qHe7GtFT59nLsidfCziDPckJ6QExyxiyjWRq0rgJC6zDU1PzrkN1OVCmePuhRbQ=",
		"-H", "priority: u=0, i",

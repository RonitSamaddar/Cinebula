...
func fetchIMDBPage(imdbID string) (string, error) {
	...
	cmd := exec.Command("curl",
		...
		"-b", "session-id=130-3844437-4031345; session-id-time=2082787201l; ubid-main=133-4880155-8879254; ci=eyJhZ2VTaWduYWwiOiJBRFVMVCIsImlzR2RwciI6ZmFsc2V9; ad-oo=0; session-token=t3hiDqkasSw8vIx8DgyFc1NPF0hpjaJadQCANgxpJ1W+BovCbECJAAI7+M5rFXUdSrKYPzNF0CaeOydU6hf/OEadK4OIllmDD4pbAKIt8oxsARFfuETdWDPp6/+gnAcPnGHwWIc1fC1Zl6SiNyRxPZxJxg5OIT4nNgOktMxQqF/eSTegeWahDNnX/wWfLUAI570G6pU5v6XbYyKmxiqd7p/JWbHnqAaR; csm-hit=tb:E2686FZ2JGHT37RM6TK5+s-K0GS4VDS1E7ABRDQZB3M|1780569194206&t:1780569194206&adb:adblk_no; aws-waf-token=3e012f03-fb89-43a7-b43c-79ed67fb5462:EQoAc4pJ8scCAAAA:2yDih0pgcPYTL74aBW623FF22105TVGfzfThQUeEzXubjSO+vHCV8XsMF43+a/TD7qgtwOJCRKvwYxHavbSvxLF+g+lc/kqG2yb5lIajod4rQbWin6RO89RhrXaTjtN+krQxe+O4ecTkdLtrZIAfj6QxS7mJcTnqkkaiYBvUsoNeOumo7iMP75Bn8m4HH+E=",
		"-H", "priority: u=0, i",
